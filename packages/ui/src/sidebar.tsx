...
const getIcon = (iconName: string) => {
    if (iconName === "Assignment") return <AssignmentIcon />;
    if (iconName === "PostAdd") return <PostAddIcon />;
...
export default function MiniDrawer({ children, title, menuItems }: { children: React.ReactNode , title: string , menuItems: { href: string, text: string, icon: string }[] }) {
